...
public class UploadTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        */
        ...
        sim.setVmid(0);
        sim.setPesNumber(1); // number of cpus

        hostList = sim.createHost(1000, 0, 2048,1000000, 10000 );
        hostList = sim.createHost(1000, 0, 4096,1000000, 10000 );

        vmlist = sim.createVM(2, 5, 0, 10000, 512, 250, 1000, 1, "THIS IS THE MOST RECENT"); //creating 5 vms
